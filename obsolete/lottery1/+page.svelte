...
// import w3, { loginWithEth } from '../Header.svelte'
...
let usdcAddress = "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"
	...
	///// Variable derived from chain data //////
	let soldTickets = 0
	////////////////////////////////////////////
		...
		<div class="cover" style="display: {display};">
			...
			<!-- <div class="cover"></div> -->
				...
				<div class="content-container">
					...
					<h2>10,000 $USDC</h2>
					<br> -->
					<p>This competition has a maximum of {totalTickets} entries.</p>
					...
					<div class="ticket-amount">
						...
						<span class="right">{totalTickets}</span>
		...
		<div class="info1">
			...
			<div class="info-box-container">
				...
				<div class="info-box">
					...
					<div>
						<h2>Prize Pool</h2>
						<p>${JSON.stringify(prize).slice(1,4)}</p>
					</div>
				</div>
				<div class="info-box">
