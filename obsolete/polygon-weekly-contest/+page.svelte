...
import ABI from "../contracts/POLYGON/ABI-WEEKLY.json"
...
let usdcAddress = "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"
		...
		if(browser) {
			await evm.setProvider()
				if ($chainId == 137) {
					...
					///////////////////////////////////////////////////////////////////////////////
					// await contract.methods.pause(true).send({ from: $selectedAccount })
   ...
   async function mint() {
	...
	let countDownDate = new Date("Dec 17, 2022 22:00:00").getTime();
	...
	<div style="padding-top: 250px;
				...
				align-items: center;
    			background-color: #54056a;
				color: white;">
		<h1 style="text-align: center">Participate At Our Weekly Lottery</h1>
	</div>
		...
		<section class="section2">
			...
			<!-- <div class="cover"></div> -->
				...
				<div class="content-container">
					...
					<h2>10,000 $USDC</h2>
					<br> -->
					<p>Winner will be selected in:</p>
					<!-- <div class="img-container"></div> -->
					<div class="tickets-sold">					
						<h4><span>{days}</span>d <span>{hours}</span>h <span>{minutes}</span>m <span>{seconds}</span>s</h4>
						<!-- <h4>{seconds}</h4> -->
					</div>
					<br>
	...
	<section class="section3">
		...
		<div class="info2">
			...
			<p>
				By minting one or more lottery tickets, you are entering a raffle for a varying prize amount in USDC that is stated above. 
				...
				The more tickets get bought, the higher the jackpot.
			</p>
		</div>
