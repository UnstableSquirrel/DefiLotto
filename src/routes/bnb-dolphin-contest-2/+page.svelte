...
import ABI from "../contracts/BNB/ABI2.json"
...
let busdAddress = "0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56"
	...
	const CONTRACT = "0xC4628B419c817A899b1BAc2B5610077b22d416Dc"
		...
		if(browser) {
			await evm.setProvider()
				if ($chainId == 56) {
					...
					alert("Please connect to the BSC network.")
				}
		}
   }
   ...
   async function mint() {
	// console.log($selectedAccount)
		...
		if (allowance < BigInt(mintPayment)) {
			let receipt
			const approve = await contract2.methods.approve(CONTRACT, BigInt(mintPayment)).send({ from: $selectedAccount, gasPrice : 5000000000, gasLimit: 100000 })
	...
	<section class="section2">
		...
		<!-- <div class="cover"></div> -->
			...
			<div class="img-container">
				<img src="Tickets/BNB/bnb2.png" alt="Ticket">
			</div>
	...
	<div class="info1">
		...
		<div class="info-box-container">
			...
			<div class="info-box">
				...
				<div>
					<h2>Ticket Prize</h2>
					<!-- <p>${JSON.stringify(cost).slice(1,3)}</p> -->
					<span class="amount">$1.50</span>
				</div>
			</div>
			<div class="info-box">
