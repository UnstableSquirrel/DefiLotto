...
import ABI from "../contracts/BNB/ABI1.json"
...
let busdAddress = "0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56"
	...
	const CONTRACT = "0x41F548C8e7a40ea9698DCF7A9E5726730f15C2Af"
   ...
   async function mint() {
	// console.log($selectedAccount)
		...
		if (BigInt(allowance) < BigInt(mintPayment)) {
			let receipt
	...
	<section class="section2">
		...
		<!-- <div class="cover"></div> -->
			...
			<div class="img-container">
				<img src="Tickets/BNB/bnb1.png" alt="Ticket">
			</div>
