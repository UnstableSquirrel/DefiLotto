...
let busdAddress = "0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56"
	...
	const CONTRACT = "0xB61364d97640F1C74324a061CaD88E1391fadA69"
			...
			<!-- <div class="cover"></div> -->
				...
				<div class="content-container">
					...
					<div class="ticket-price">
						<span class="amount">${JSON.stringify(cost).slice(1, cost.length - 17)}</span>
		...
		<div class="info1">
			...
			<div class="info-box-container">
				...
				<div class="info-box">
					...
					<div>
						<h2>Ticket Prize</h2>
						<p>${JSON.stringify(cost).slice(1, cost.length - 17)}</p>
					</div>
				</div>
				<div class="info-box">
