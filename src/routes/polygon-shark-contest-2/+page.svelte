...
import ABI from "../contracts/POLYGON/ABI2.json"
...
let usdcAddress = "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"
	...
	const CONTRACT = "0x481A06c7E7dBd44855852Ed5E5c78D5412BAf81F"
			...
			<!-- <div class="cover"></div> -->
				...
				<div class="content-container">
					...
					<div class="ticket-amount">
						...
						{#if soldTickets >= 5000}
						<p>Only {remainingTickets.toLocaleString('en-IN')} remaining!</p>
						{/if}
						{#if soldTickets < 5000}
						<p>{remainingTickets.toLocaleString('en-IN')} remaining!</p>
						{/if}
					</div>
		
					<div class="ticket-price">
						<span class="amount">${JSON.stringify(cost).slice(1, cost.length - 5)}</span>
		...
		<div class="info1">
			...
			<div class="info-box-container">
				...
				<div class="info-box">
					...
					<div>
						<h2>Ticket Prize</h2>
						<p>${JSON.stringify(cost).slice(1, cost.length - 5)}</p>
					</div>
				</div>
				<div class="info-box">
